...
namespace CE_API_V2.Migrations
{
    ...
    [Migration("20231127063915_AddedDraftBiomarkers")]
    partial class AddedDraftBiomarkers
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CE_API_V2.Models.Biomarkers", b =>
                {
                    ...
                    b.Property<string>("ClinicalSettingDisplayValue")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("ClinicalSettingUnit")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("CE_API_V2.Models.BiomarkersDraft", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("CE_API_V2.Models.BiomarkersDraft", b =>
                {
                    b.HasOne("CE_API_V2.Models.ScoringRequestModel", "Request")
                        .WithMany("BiomarkersDraft")
                        .HasForeignKey("RequestId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("CE_API_V2.Models.ScoringResponseModel", "Response")
                        .WithMany()
